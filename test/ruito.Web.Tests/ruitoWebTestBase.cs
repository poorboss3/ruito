...
{
    public abstract class ruitoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ruitoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ruitoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ruitoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ruitoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ruitoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ruitoDbContext, Task<T>> func)
        {
            T result;
